# Generated by Django 4.1.3 on 2023-04-07 17:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('reference_code', models.CharField(blank=True, max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_center', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.costcenter')),
